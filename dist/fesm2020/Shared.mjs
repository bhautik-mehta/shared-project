...
AuthService.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.7", ngImport: i0, type: AuthService, deps: [{ token: i1.AngularFireAuth }, { token: i1$1.AngularFirestore }, { token: i3.AngularFireStorage }], target: i0.ɵɵFactoryTarget.Injectable });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.7", ngImport: i0, type: AuthService, decorators: [{
            type: Injectable
        }], ctorParameters: function () { return [{ type: i1.AngularFireAuth }, { type: i1$1.AngularFirestore }, { type: i3.AngularFireStorage }]; } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.7", ngImport: i0, type: SignupComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1$3.FormBuilder }, { type: AuthService }]; }, propDecorators: { position: [{
                type: Input
            }], mode: [{
                type: Input
            }], signUpApiOutput: [{
...
LoginComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.7", ngImport: i0, type: LoginComponent, deps: [{ token: i1$3.FormBuilder }, { token: AuthService }], target: i0.ɵɵFactoryTarget.Component });
...
CamerahomeComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.7", ngImport: i0, type: CamerahomeComponent, deps: [{ token: i1$1.AngularFirestore }, { token: AuthService }, { token: i3.AngularFireStorage }, { token: i4.Camera }], target: i0.ɵɵFactoryTarget.Component });
CamerahomeComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.2.7", type: CamerahomeComponent, selector: "shared-camerahome", inputs: { position: "position", mode: "mode" }, outputs: { cameraHomeApiOutput: "cameraHomeApiOutput" }, ngImport: i0, template: "<ion-header [translucent]=\"true\">\r\n  <ion-toolbar color=\"primary\">\r\n    <ion-title>\r\n      My home camera\r\n    </ion-title>\r\n  </ion-toolbar>\r\n</ion-header>\r\n<ion-content [fullscreen]=\"true\">\r\n  <ion-content class=\"ion-padding\">\r\n    <div class=\"preview\">\r\n      this is camerahome works!\r\n\r\n      <div class=\"camera\">\r\n        <!-- <input type=\"file\" id=\"file\" #userPhoto (change)=\"onFileSelected($event)\" name=\"image\" autocomplete=\"off\" /> -->\r\n        <!-- <ion-button [mode]=\"mode\" expand=\"block\" color=\"primary\" (click)=\"expression\")></ion-button> -->\r\n        <div class=\"file-upload\" (click)=\"changeImage()\">\r\n          <!-- <img [src]=\"\" /> -->\r\n        </div>\r\n\r\n      </div>\r\n    </div>\r\n  </ion-content>\r\n</ion-content>\r\n", styles: [".file-upload{width:80px;height:80px;background-color:#0ff}\n"], components: [{ type: i1$2.IonHeader, selector: "ion-header", inputs: ["collapse", "mode", "translucent"] }, { type: i1$2.IonToolbar, selector: "ion-toolbar", inputs: ["color", "mode"] }, { type: i1$2.IonTitle, selector: "ion-title", inputs: ["color", "size"] }, { type: i1$2.IonContent, selector: "ion-content", inputs: ["color", "forceOverscroll", "fullscreen", "scrollEvents", "scrollX", "scrollY"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.7", ngImport: i0, type: CamerahomeComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1$1.AngularFirestore }, { type: AuthService }, { type: i3.AngularFireStorage }, { type: i4.Camera }]; }, propDecorators: { position: [{
                type: Input
            }], mode: [{
                type: Input
            }], cameraHomeApiOutput: [{
...
CheckboxComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.2.7", type: CheckboxComponent, selector: "ui-checkbox", inputs: { color: "color", isChecked: "isChecked", slot: "slot", name: "name", readonly: "readonly", label: "label", mode: "mode", disabled: "disabled" }, outputs: { checkInputValue: "checkInputValue" }, providers: [{
            ...
            multi: true
        }], ngImport: i0, template: "<ion-checkbox \r\n  [color]=\"color\"\r\n  [checked]=\"isChecked\"\r\n  [slot]=\"slot\"\r\n  [name]=\"name\"\r\n  [disabled]=\"readonly\"\r\n  (ionChange)=\"onCheckClick()\"\r\n  [mode]=\"mode\"\r\n></ion-checkbox>\r\n<ui-label [color]=\"color\" [text]=\"label\"></ui-label>", styles: [""], components: [{ type: i1$2.IonCheckbox, selector: "ion-checkbox", inputs: ["checked", "color", "disabled", "indeterminate", "mode", "name", "value"] }, { type: LabelComponent, selector: "ui-label", inputs: ["text", "class", "color", "position", "mode"] }], directives: [{ type: i1$2.BooleanValueAccessor, selector: "ion-checkbox,ion-toggle" }] });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.7", ngImport: i0, type: ShowimgComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1$1.AngularFirestore }, { type: AuthService }, { type: i3.AngularFireStorage }]; }, propDecorators: { position: [{
                type: Input
            }], mode: [{
                type: Input
            }], showImgApiOutput: [{
