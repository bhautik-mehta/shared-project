...
import * as i1$2 from '@angular/fire/compat/database';
...
InputComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.2.7", type: InputComponent, selector: "ui-input", inputs: { placeholder: "placeholder", type: "type", name: "name", color: "color", readonly: "readonly", required: "required", mode: "mode", disabled: "disabled", value: "value" }, outputs: { newValue: "newValue" }, providers: [{
            ...
            multi: true
        }], ngImport: i0, template: "<ion-input \r\n    [color]=\"color\"\r\n    [placeholder]=\"placeholder\" \r\n    [type]=\"type\" \r\n    [name]=\"name\" \r\n    [readonly]=\"readonly\" \r\n    [required]=\"required\"\r\n    [disabled]=\"disabled\"\r\n    (ionChange)=\"onInputChange()\"\r\n    [mode]=\"mode\"\r\n    [(ngModel)]=\"value\"\r\n>\r\n</ion-input>\r\n", styles: [""], components: [{ type: i3$1.IonInput, selector: "ion-input", inputs: ["accept", "autocapitalize", "autocomplete", "autocorrect", "autofocus", "clearInput", "clearOnEdit", "color", "debounce", "disabled", "enterkeyhint", "inputmode", "max", "maxlength", "min", "minlength", "mode", "multiple", "name", "pattern", "placeholder", "readonly", "required", "size", "spellcheck", "step", "type", "value"] }], directives: [{ type: i3$1.TextValueAccessor, selector: "ion-input:not([type=number]),ion-textarea,ion-searchbar" }, { type: i1$1.RequiredValidator, selector: ":not([type=checkbox])[required][formControlName],:not([type=checkbox])[required][formControl],:not([type=checkbox])[required][ngModel]", inputs: ["required"] }, { type: i1$1.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { type: i1$1.NgModel, selector: "[ngModel]:not([formControlName]):not([formControl])", inputs: ["name", "disabled", "ngModel", "ngModelOptions"], outputs: ["ngModelChange"], exportAs: ["ngModel"] }] });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.7", ngImport: i0, type: SignupComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1$1.FormBuilder }, { type: AuthService }]; }, propDecorators: { position: [{
                type: Input
            }], mode: [{
                type: Input
            }], signUpApiOutput: [{
...
LoginComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.7", ngImport: i0, type: LoginComponent, deps: [{ token: i1$1.FormBuilder }, { token: AuthService }], target: i0.ɵɵFactoryTarget.Component });
...
CameraComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.7", ngImport: i0, type: CameraComponent, deps: [{ token: AuthService }, { token: i3$1.LoadingController }, { token: i3$1.AlertController }, { token: i3$2.Router }], target: i0.ɵɵFactoryTarget.Component });
CameraComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.2.7", type: CameraComponent, selector: "shared-camera", inputs: { position: "position", mode: "mode" }, outputs: { cameraApiOutput: "cameraApiOutput" }, ngImport: i0, template: "<ion-header [translucent]=\"true\">\r\n  <ion-toolbar color=\"primary\">\r\n    <ion-title>\r\n      My profile\r\n    </ion-title>\r\n  </ion-toolbar>\r\n</ion-header>\r\n\r\n<ion-content [fullscreen]=\"true\">\r\n  <ion-content class=\"ion-padding\">\r\n    <div class=\"preview\">\r\n      <ion-avatar (click)=\"changeImage()\">\r\n        <img *ngIf=\"imageUrl; else placheholder_avatar;\" [src]=\"imageUrl\" />\r\n         <ng-template #placheholder_avatar>\r\n           <div class=\"fallback\">\r\n             <p>Select avatar</p>\r\n           </div>\r\n        </ng-template>\r\n      </ion-avatar>\r\n    </div>\r\n   </ion-content>\r\n</ion-content>\r\n", styles: [""], components: [{ type: i3$1.IonHeader, selector: "ion-header", inputs: ["collapse", "mode", "translucent"] }, { type: i3$1.IonToolbar, selector: "ion-toolbar", inputs: ["color", "mode"] }, { type: i3$1.IonTitle, selector: "ion-title", inputs: ["color", "size"] }, { type: i3$1.IonContent, selector: "ion-content", inputs: ["color", "forceOverscroll", "fullscreen", "scrollEvents", "scrollX", "scrollY"] }, { type: i3$1.IonAvatar, selector: "ion-avatar" }], directives: [{ type: i7.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.7", ngImport: i0, type: CameraComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: AuthService }, { type: i3$1.LoadingController }, { type: i3$1.AlertController }, { type: i3$2.Router }]; }, propDecorators: { position: [{
                type: Input
            }], mode: [{
                type: Input
            }], cameraApiOutput: [{
...
CheckboxComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.2.7", type: CheckboxComponent, selector: "ui-checkbox", inputs: { color: "color", isChecked: "isChecked", slot: "slot", name: "name", readonly: "readonly", label: "label", mode: "mode", disabled: "disabled" }, outputs: { checkInputValue: "checkInputValue" }, providers: [{
            ...
            multi: true
        }], ngImport: i0, template: "<ion-checkbox \r\n  [color]=\"color\"\r\n  [checked]=\"isChecked\"\r\n  [slot]=\"slot\"\r\n  [name]=\"name\"\r\n  [disabled]=\"readonly\"\r\n  (ionChange)=\"onCheckClick()\"\r\n  [mode]=\"mode\"\r\n></ion-checkbox>\r\n<ui-label [color]=\"color\" [text]=\"label\"></ui-label>", styles: [""], components: [{ type: i3$1.IonCheckbox, selector: "ion-checkbox", inputs: ["checked", "color", "disabled", "indeterminate", "mode", "name", "value"] }, { type: LabelComponent, selector: "ui-label", inputs: ["text", "class", "color", "position", "mode"] }], directives: [{ type: i3$1.BooleanValueAccessor, selector: "ion-checkbox,ion-toggle" }] });
...
ShowimgComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.2.7", ngImport: i0, type: ShowimgComponent, deps: [{ token: i1$2.AngularFireDatabase }, { token: AuthService }, { token: i3.AngularFireStorage }], target: i0.ɵɵFactoryTarget.Component });
ShowimgComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.2.7", type: ShowimgComponent, selector: "shared-showimg", inputs: { position: "position", mode: "mode" }, outputs: { showImgApiOutput: "showImgApiOutput" }, ngImport: i0, template: "<ion-header [translucent]=\"true\">\n  <ion-toolbar color=\"primary\">\n    <ion-title>\n      My home camera\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n<ion-content [fullscreen]=\"true\">\n  <ion-content class=\"ion-padding\">\n    <div class=\"preview\">\n      this is preview below\n      <div class=\"show-img\">\n        <div class=\"images-preview\">\n          <img src=\"https://via.placeholder.com/500\" class=\"img-responsive\" />\n        </div>\n        <div class=\"images-preview\">\n          <img src=\"https://via.placeholder.com/200\" class=\"img-responsive\" />\n        </div>\n        <div class=\"images-preview\">\n          <img src=\"https://via.placeholder.com/300\" class=\"img-responsive\" />\n        </div>\n        <div class=\"images-preview\">\n          <img src=\"https://via.placeholder.com/900\" class=\"img-responsive\" />\n        </div>\n        <div class=\"images-preview\">\n          <img src=\"https://via.placeholder.com/1500\" class=\"img-responsive\" />\n        </div>\n        <div class=\"images-preview\">\n          <img src=\"https://via.placeholder.com/400\" class=\"img-responsive\" />\n        </div>\n      </div>\n    </div>\n  </ion-content>\n</ion-content>\n", styles: [".show-img{display:grid;grid-template-columns:repeat(5,1fr);grid-gap:10px;gap:10px}.images-preview{height:300px;width:300px;object-fit:contain}.img-responsive{width:100%;height:100%;max-width:100%;max-height:100%;object-fit:contain}\n"], components: [{ type: i3$1.IonHeader, selector: "ion-header", inputs: ["collapse", "mode", "translucent"] }, { type: i3$1.IonToolbar, selector: "ion-toolbar", inputs: ["color", "mode"] }, { type: i3$1.IonTitle, selector: "ion-title", inputs: ["color", "size"] }, { type: i3$1.IonContent, selector: "ion-content", inputs: ["color", "forceOverscroll", "fullscreen", "scrollEvents", "scrollX", "scrollY"] }] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.2.7", ngImport: i0, type: ShowimgComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i1$2.AngularFireDatabase }, { type: AuthService }, { type: i3.AngularFireStorage }]; }, propDecorators: { position: [{
                type: Input
            }], mode: [{
                type: Input
            }], showImgApiOutput: [{
